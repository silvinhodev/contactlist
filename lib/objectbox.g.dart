...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 2761970928210775872),
      name: 'ContactModel',
      lastPropertyId: const IdUid(3, 7689849335879901880),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 7172456119015303439),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 1335065517310788035),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 7689849335879901880),
            name: 'email',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 2761970928210775872),
